...
function App() {
  ...
  return (
    <div id="main">
      ...
      <select id="state" value={stateIndex} onChange={(e) => setStateIndex(parseInt(e.target.value))}>
      ...
      <select id="city" value={cityIndex} onChange={(e) => setCityIndex(parseInt(e.target.value))}>
